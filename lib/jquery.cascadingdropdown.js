...
(function ($, undefined) {
    ...
    Dropdown.prototype = {
        ...
        _renderItems: function (items) {
            ...
            //added by anson begin
            if (self.originalDropdownItems.length > 1 || (self.originalDropdownItems.length == 1 && self.originalDropdownItems[0].className != "originalOption")) {
                self.enable();
                self.originalDropdownItems = [];
                return;
            }
            //added by anson end
